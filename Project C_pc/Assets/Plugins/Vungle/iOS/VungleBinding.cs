...
public class VungleBinding
{
	...
	private static extern void _vungleStartWithAppId(string appId, string[] placements, int placementsCount, string pluginVersion, bool initHeaderBiddingDelegate);
	...
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
			_vungleStartWithAppId(appId, placements, placements.Length, pluginVersion, false);
	}
	public static void startWithAppId(string appId, string[] placements, string pluginVersion, bool initHeaderBiddingDelegate)
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
			_vungleStartWithAppId(appId, placements, placements.Length, pluginVersion, initHeaderBiddingDelegate);
	}
